    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <form action="../config/foto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" name="userid" value="<?= $_SESSION['userid'] ?>" hidden required>
                        ...
                        <tbody>
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['fotoid'] ?>">
                                 ...
                                 <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        <form action="../config/foto.php" method="post">
                                            <input type="hidden" name="fotoid" value="<?php echo $data['fotoid'] ?>">
